...
declare namespace ClCrud {
  ...
  interface Service {
    api: {
      page(params?: obj): Promise<{ list: any[]; pagination: Pagination; [key: string]: any }>
...
declare namespace ClUpsert {
  interface Config {
    ...
    onClosed?(): void
    onInfo?(data: obj, event: { close: fn; done(data: obj): void; next: ClCrud.Service['api']['info'] }): void
    onSubmit?(data: obj, event: { close: fn; done: fn; next: ClCrud.Service['api']['update'] }): void
